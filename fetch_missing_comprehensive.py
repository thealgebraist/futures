...
def get_6mo_data(symbol):
    ...
    if all_data:
        ...
        print(f"Saved {len(resampled)} rows for {symbol}")

if __name__ == "__main__":
    missing = ['BONKUSDT', 'MANAUSDT', 'APEUSDT', 'XLMUSDT', 'SUSHIUSDT', 'ONDOUSDT', 'TRXUSDT', 'WLDUSDT', 'XTZUSDT', 'TONUSDT', 'ATOMUSDT', 'HYPEUSDT']
